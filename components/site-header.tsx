    ...
    <header className="sticky top-0 z-40 w-full border-b bg-background/80 backdrop-blur">
      <div className="container mx-auto h-16 md: px-[8%] flex items-center justify-between">
        <nav className="font-semibold tracking-tight">
          <a href="#hero" className="text-balance text-xl md: text-2xl pointer-events-auto">0BlackRaven</a>
        </nav>

        <nav aria-label="Main navigation" className="">
          <div className="flex flex-row items-center md:gap-6 hidden md:block pointer-events-auto">
            {
              sections.map(sec => (
